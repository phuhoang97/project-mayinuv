      ...
      {alldata ? (
        <div className='t-container'>
            ...
            <div className='detailsProduct'>
              ...
              >
                <TabPane tab='Mô tả' key='1' style={{ width: "100%" }}>
                  <div>
                    <p>
                      Máy in UV phẳng YF-2512K được lắp đặt đầu in Kyocera KJ4A.
                      Đầu có hai kênh có thể sử dụng 1/2 màu. Chế độ in có thể
                      là 4C / 6C / 4C + W / 6C + W / 4C + W + V / 6C + W + V.
                      Máy in UV FORTUNE của chúng tôi là một loại máy in phẳng
                      UV có độ chính xác cao được thiết kế đặc biệt cho các
                      doanh nghiệp xử lý cá nhân để đáp ứng các yêu cầu cá nhân
                      và độ chính xác cao. Được trang bị 2-9 đầu in Kyocera, máy
                      in có thể in ở tốc độ cao cũng như độ chính xác cao với
                      4-7 màu 720 * 1800 DPI. Ngoài ra, chế độ mực trắng tùy
                      chọn và chế độ véc ni cũng làm sáng đa chức năng, tạo ra
                      nhiều hình ảnh thực hơn và nhiều ứng dụng hơn.
                    </p>
                    ...
                    <p className='mt-20'>Để định vị chính xác các vật liệu.</p>
                    ...
                    <p className='mt-20'>
                      Hệ thống sẽ tự động dừng lại khi chạm vào vật liệu cao hơn
                      cỗ xe để bảo vệ đầu in.
                    </p>
                  </div>
                </TabPane>
          ...
          <section className='third-section mt-20'>
            <h3 style={{ color: "rgb(219, 68, 68)" }}>Related Items</h3>
            <Row gutter={[16, 16]}>
